...
% UMD Experiences
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item{Facilitating communication between professor and students, and assisting with management of Unity-based Game Programming course}
        \item{Tutoring students individually to improve understanding of course topics}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item{Designed k-d tree-based false positive particle filtering system, reducing noise in particle data by more than 40\% to improve downstrain clustering}
