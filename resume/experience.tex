...
% UMD Experiences
  ...
  \cventry
    ...
    {September 2025 - Present}
    {
      \begin{cvitems}
        ...
        \item{Coordinating with group of 3 other Teachers Assistants, delegating grading workload and preparing organization tools for the class}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item{Spearheaded the design and development of an Agentic LLM Assistant for presentation creation, fit with Q\&A support capabilities as well as integrations with newly created VectorDB internal knowlege base for Retrieval Augmented Generation (RAG), content library APIs, and internal financial applications}
